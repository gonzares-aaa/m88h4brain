...
bool WCECore::Init( HWND hWnd, Draw *pDraw, DiskManager *pDiskmgr,
...
bool WCECore::ConnectDevices(PC8801::WCEKeyIF* keyb)
{
	const static IOBus::Connector c_keyb[] = 
	{
		{ PC88::pres, IOBus::portout, WCEKeyIF::reset },
		{ PC88::vrtc, IOBus::portout, WCEKeyIF::vsync },
		{ 0x00, IOBus::portin, WCEKeyIF::in },
		{ 0x01, IOBus::portin, WCEKeyIF::in },
		{ 0x02, IOBus::portin, WCEKeyIF::in },
		{ 0x03, IOBus::portin, WCEKeyIF::in },
		{ 0x04, IOBus::portin, WCEKeyIF::in },
		{ 0x05, IOBus::portin, WCEKeyIF::in },
		{ 0x06, IOBus::portin, WCEKeyIF::in },
		{ 0x07, IOBus::portin, WCEKeyIF::in },
		{ 0x08, IOBus::portin, WCEKeyIF::in },
		{ 0x09, IOBus::portin, WCEKeyIF::in },
		{ 0x0a, IOBus::portin, WCEKeyIF::in },
		{ 0x0b, IOBus::portin, WCEKeyIF::in },
		{ 0x0c, IOBus::portin, WCEKeyIF::in },
		{ 0x0d, IOBus::portin, WCEKeyIF::in },
		{ 0x0e, IOBus::portin, WCEKeyIF::in },
		{ 0x0f, IOBus::portin, WCEKeyIF::in },
		{ 0, 0, 0 }
	};
...
void WCECore::ApplyConfig(PC8801::Config *pConfig)
{
	PC88::ApplyConfig( pConfig );
	sound.ApplyConfig( pConfig );
...
void WCECore::Activate( bool blActive )
{
CriticalSection::Lock lock( m_cscpu );
...
void WCECore::ExecuteAsynchronus()
{
	if( m_iClock <= 0 )
	{
	DWORD dwMS;
...
void WCECore::Execute( long lClock, long lLength, long lEffclock )
{
CriticalSection::Lock lock( m_cscpu );
