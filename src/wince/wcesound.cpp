...
//	合成・再生レート変更
//
bool WceSound::ChangeRate(uint rate, uint32 clock, uint buflen, bool waveout)
{
...
//	設定更新
//
void WceSound::ApplyConfig(const Config* config)
{
...
//	合成の場合
//
void WceSound::Mix(Sample* dest, int samples, Sample* dest2, int samples2)
{
