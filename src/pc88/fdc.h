...
//	uPD765A
// ---------------------------------------------------------------------------
//	$Id: fdc.h,v 1.10 1999/10/10 01:47:06 cisc Exp $
...
public:
	...
	bool Init(DiskManager* dm, Scheduler* scheduler, IOBus* bus, int intport);
	void ShowStatus(bool show) { showstatus = show; }
