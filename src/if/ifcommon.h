...
//	拡張モジュール用インターフェース定義
// ----------------------------------------------------------------------------
//	$Id: ifcommon.h,v 1.5 1999/11/26 10:13:36 cisc Exp $
...
struct IWinUI
{
	...
	virtual bool IFCALL HookExtention(IWinUIExtention* ext) = 0;
	virtual bool IFCALL UnhookExtention(IWinUIExtention* ext) = 0;
};
